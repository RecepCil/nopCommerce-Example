...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        {
            AddNotification(NotifyType.Error, message+"\nBase Controller'dan Error Notification'ı dinlediniz", persistForTheNextRequest);
        }
        /// <summary>
        /// Display error notification
        /// </summary>
        ...
        protected virtual void AddNotification(NotifyType type, string message, bool persistForTheNextRequest)
        {
            ...
            if (persistForTheNextRequest)   //Sonraki istek için devam et?
            {
        ...
        {
            //locales'e tüm languageId'leri ekle
