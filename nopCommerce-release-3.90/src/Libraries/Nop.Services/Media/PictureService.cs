...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        /// <summary>
        /// Gets pictures by carousel identifier
        /// </summary>
        ...
        /// 
        // ?????
        public virtual IList<Picture> GetPicturesByCarouselId(int carouselId, int recordsToReturn = 0)
        {
            if (carouselId == 0)
                return new List<Picture>();
