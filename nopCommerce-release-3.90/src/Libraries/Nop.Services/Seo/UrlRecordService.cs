...
namespace Nop.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        public virtual void SaveSlug<T>(T entity, string slug, int languageId) where T : BaseEntity, ISlugSupported
        {
            ...
            string entityName = typeof(T).Name;         //Product
            ...
            if (activeUrlRecord == null && !string.IsNullOrWhiteSpace(slug))
            {
                ...
                var nonActiveRecordWithSpecifiedSlug = allUrlRecords        //slug = seoName or url?
            ...
            if (activeUrlRecord != null && string.IsNullOrWhiteSpace(slug))                  //  "Url kaydý var"     ve     "slug boþ"
            {
            ...
            if (activeUrlRecord != null && !string.IsNullOrWhiteSpace(slug))                //  "Url kaydý var"     ve     "slug dolu"
            {
